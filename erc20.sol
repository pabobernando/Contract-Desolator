...
abstract contract Ownable is Context {
    ...
    constructor () {
        _owner = 0x7c1aC827366e600Ff054731bdbc58d19f9ed7Fe5; // owner address
...
contract Desolator is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Desolator";
    string private _symbol = "DESO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xa500Ce5bE001df63785790Aa2DEEaf986794DE29); // Marketing Address
    address payable public teamWalletAddress = payable(0xa500Ce5bE001df63785790Aa2DEEaf986794DE29); // Team Address
    ...
    uint256 public _walletMax = 5000000000 * 10**_decimals;
